...
export default function CreateLobbyForm({ games }: CreateLobbyFormProps) {
  const { user } = useUser();
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter lobby description" {...field} />
                  </FormControl>
                  <FormDescription>
                ...
                <FormItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{field.value} players</span>
                      <span className="text-sm text-muted-foreground">10</span>
                    </div>
                  </div>
                  <FormDescription>
                    Set the maximum number of players for your lobby
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center space-x-2 space-y-0">
                  ...
                  <FormLabel>Create lobby with pool</FormLabel>
                </FormItem>
              )}
            />
            {withPool && (
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        This is the initial amount you&apos;ll contribute to the
                        pool and entry fee for other players
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button type="submit" disabled={isPending || isLoading}>
              ...
              {isPending || isLoading ? "Creating..." : "Create Lobby"}
            </Button>
          </CardFooter>
        </form>
      </Form>
