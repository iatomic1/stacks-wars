...
export default function CreateLobbyForm({ games }: { games: Game[] }) {
			...
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onSubmit)}>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>
										Choose which game will be played in this
										pool
									</FormDescription>
									<FormMessage />
								</FormItem>
					...
					<CardFooter className="flex justify-between">
						...
						<Button
							disabled={isPending}
							onClick={() => router.push("/lobby/pool-123456")}
						>
							{isPending && (
								<Loader
