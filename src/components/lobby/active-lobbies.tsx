        ...
        <Card key={lobby.id} className="overflow-hidden">
          <CardHeader className="pb-3">
            <div className="flex justify-between items-start">
              ...
              <Badge
                variant={lobby.status === "open" ? "default" : "secondary"}
              >
                {lobby.status === "open" ? "Open" : "Full"}
              </Badge>
            </div>
            <CardDescription>
              Created by {truncateAddress(lobby.creator.stxAddress)}
            </CardDescription>
          </CardHeader>
          <CardContent className="pb-3">
            <div className="grid gap-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{lobby.game.name}</span>
              </div>
          ...
          <CardFooter>
            <Button
              asChild
              variant={lobby.status === "open" ? "default" : "outline"}
